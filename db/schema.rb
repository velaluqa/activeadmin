...
ActiveRecord::Schema.define(version: 20170614114308) do
  ...
  create_table "required_series", force: :cascade do |t|
  ...
  add_index "required_series", ["image_series_id"], name: "index_required_series_on_image_series_id", using: :btree
  add_index "required_series", ["visit_id", "name"], name: "index_required_series_on_visit_id_and_name", unique: true, using: :btree
