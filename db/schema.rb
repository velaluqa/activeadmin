...
ActiveRecord::Schema[7.0].define(version: 2022_12_14_132751) do
  ...
  create_table "notifications", id: :serial, force: :cascade do |t|
    ...
    t.datetime "marked_seen_at", precision: nil
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "required_series", id: :serial, force: :cascade do |t|
    ...
    t.integer "image_series_id"
    t.integer "tqc_state"
    t.datetime "tqc_date", precision: nil
  ...
  create_table "visits", id: :serial, force: :cascade do |t|
    ...
    t.string "domino_unid"
    t.string "description"
    t.datetime "mqc_date", precision: nil
