...
ActiveRecord::Schema.define(version: 20_170_420_114_823) do
  ...
  add_index 'cases', %w[session_id position], name: 'index_cases_on_session_id_and_position', unique: true, using: :btree
  ...
  add_index 'centers', %w[study_id code], name: 'index_centers_on_study_id_and_code', unique: true, using: :btree
  ...
  add_index 'image_series', %w[patient_id series_number], name: 'index_image_series_on_patient_id_and_series_number', using: :btree
  ...
  add_index 'notification_profile_roles', %w[notification_profile_id role_id], name: 'index_notification_profile_roles_join_table_index', unique: true, using: :btree
  ...
  add_index 'notification_profile_users', %w[notification_profile_id user_id], name: 'index_notification_profile_users_join_table_index', unique: true, using: :btree
  ...
  add_index 'notifications', %w[resource_type resource_id], name: 'index_notifications_on_resource_type_and_resource_id', using: :btree
  ...
  add_index 'readers_sessions', %w[user_id session_id], name: 'index_readers_sessions_on_user_id_and_session_id', using: :btree
  ...
  add_index 'user_roles', %w[scope_object_type scope_object_id], name: 'index_user_roles_on_scope_object_type_and_scope_object_id', using: :btree
  ...
  add_index 'validators_sessions', %w[user_id session_id], name: 'index_validators_sessions_on_user_id_and_session_id', using: :btree
