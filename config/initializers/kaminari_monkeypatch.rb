# originally lib/kaminari/hooks.rb
# we need to monkey-patch this in order to prevent Kaminari (pagination component used by ActiveAdmin) from requiring DataMapper
# including DataMapper overrides the Symbol.in method/operator of Mongoid
