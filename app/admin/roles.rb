ActiveAdmin.register Role do
  ...
  form do |f|
    ...
    f.inputs 'Role details' do
      ...
      f.input :role, :collection => {'Manager' => :manage, 'Audit' => :audit, 'Read-only' => :readonly}, :as => :select, :include_blank => false, :hint => 'Please note that audit and read-only roles cannot be assigned system-wide and have to be assigned at a study or session level.'
    end
